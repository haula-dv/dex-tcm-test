...
export const formatMarkPriceNoDecimal = (mark_price: any) => {
  if (!mark_price) return "0";

  const [integerPart, decimalPart] = String(mark_price).split(".");
