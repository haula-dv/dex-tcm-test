			...
			<Stack spacing={TSizes.margin_xs} py={TSizes.margin_xs}>
				...
				<MainCard>
					...
					<Typography textAlign={'center'}>
						ONDO is the governance token for Flux Finance and the Ondo DAO. ONDO is the governance token for Flux
						Finance and the Ondo DAO. ONDO is the governance token for Flux Finance and the Ondo DAO.
					</Typography>
