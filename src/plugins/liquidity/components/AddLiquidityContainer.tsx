...
export const AddLiquidityContainer = () => {
	...
	return (
		<MainCard variant="outlined" backgroudColor="white">
			...
			{!isApprove ? (
				<MainButton fullWidth size="large" variant="contained" color="darkPrimary" onClick={handlSubmitInvalid}>
					Invalid Pair
				</MainButton>
			) : (
				<Stack spacing={2}>
					<MainButton fullWidth size="large" variant="contained" color="darkPrimary">
						Approve WBTC
					</MainButton>

					<MainButton fullWidth size="large" variant="contained" color="darkPrimary" disabled>
						Supply
					</MainButton>
				</Stack>
			)}
