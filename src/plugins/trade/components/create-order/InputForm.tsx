...
function InputForm({
  ...
  const onChangeQuanityExt = (val: any) => {
    ...
    formContext.setValue(
      "total",
      !newValue ? "" : (newWatchValue.total as any),
      {
        shouldValidate: true,
        shouldDirty: false,
      }
          ...
          rules={{
            validate: {
              custom: async (_, data) => {
                ...
                return errors?.trigger_price != null
                  ? errors.trigger_price.message
                  : true;
              },
            },
          }}
            ...
            rules={{
              validate: {
                custom: async (_, data) => {
                  ...
                  return errors?.order_price != null
