...
export const PoolContainer = () => {
	return (
		<Box display={'flex'} justifyContent={'center'} alignItems={'center'} minHeight={'calc(100vh - 56px)'}>
			<Box maxWidth={TSizes.widthCommonCard}>
				<Stack spacing={2} alignItems={'center'} width={'100%'}>
					<MainCard backgroudColor={setColorThemeMode('white', 'primary')} width="100%">
					...
					<MainCard backgroudColor="primary" width="100%">
						...
						<MainCard isHover width="100%" backgroudColor="darkgrey">
