...
export const TokenSelected = () => {
  ...
  const [isOpenConfirmRemoveLiquidity, setOpenConfirmRemoveLiquidity] =
    useState(false);
  const [isOpenSignatureRequest, setOpenSignatureRequest] = useState(false);
  const [isOpenSignatureRequestConfirm, setIsOpenSignatureRequestConfirm] =
    useState(false);
  ...
  return (
    <>
      ...
      <ModalConfirmLiquidity
        open={isOpenConfirmRemoveLiquidity}
      ...
      <SignatureRequestModal
        ...
        handleToggleSignatureRequestConfirm={
          handleToggleSignatureRequestConfirm
        }
      />
